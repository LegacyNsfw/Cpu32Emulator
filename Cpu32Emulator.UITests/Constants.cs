namespace Cpu32Emulator.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5001/";
    public readonly static string iOSAppName = "com.companyname.cpu32emulator";
    public readonly static string AndroidAppName = "com.companyname.cpu32emulator";
